...
- (NSString *) description {
    return [NSString stringWithFormat:@"lbsIP=%@,uploadHosts=%@, lbsHttpCode=%ld, lbsSucc=%ld, lbsUseTime=%lld,net=%@, hasPushed=%d, lastmodified=%lld",
            _lbsIP, _uploaderHosts, (long)_lbsHttpCode, (long)_lbsSucc, _lbsUseTime, _net, _hasPushed, _lastModified];
}
